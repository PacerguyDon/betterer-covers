...
export function fetchListItemsForUser(activeUser: string, selectedSlug: string, signal: AbortSignal, { user, slug, signal }: { user: string; slug: string; signal?: AbortSignal; }) {
